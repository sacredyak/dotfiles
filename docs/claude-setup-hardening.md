...
**Files:**
- Modify: `/Users/bharat/.dotfiles/claude/.claude/hooks/auto-mode.sh`
...
- [ ] **Step 1:** Replace `/Users/bharat/.dotfiles/claude/.claude/hooks/auto-mode.sh` — add `PENDING`, `LOGFILE` tracking, timestamp validation, confirmation logic
...
- [ ] **Step 3:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/hooks/auto-mode.sh && git -C /Users/bharat/.dotfiles commit -m "security(auto-mode): add 30s confirmation window and logging"`
...
**Priority:** P0 — Security  
**Files:**
- Modify: `/Users/bharat/.dotfiles/claude/.claude/hooks/destructive-guard.sh`
...
- [ ] **Step 3:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/hooks/destructive-guard.sh && git -C /Users/bharat/.dotfiles commit -m "security(destructive-guard): block rm -rf variable bypasses"`
...
**Files:**
- Create: `/Users/bharat/.dotfiles/claude/.claude/hooks/orchestrator-guard.sh`
- Modify: `/Users/bharat/.dotfiles/claude/.claude/settings.json`
...
- [ ] **Step 4:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/hooks/orchestrator-guard.sh claude/.claude/settings.json && git -C /Users/bharat/.dotfiles commit -m "refactor(orchestrator-guard): extract to blocking script"`
...
**Files:**
- Modify: `/Users/bharat/.dotfiles/claude/.claude/CLAUDE.md`
...
- [ ] **Step 2:** Verify: `grep "allowlisted commands:" /Users/bharat/.dotfiles/claude/.claude/CLAUDE.md`
- [ ] **Step 3:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/CLAUDE.md && git -C /Users/bharat/.dotfiles commit -m "docs(CLAUDE.md): sync Bash allowlist with settings.json"`
...
**Priority:** P1 — Documentation  
**Files:**
- Create: `/Users/bharat/.dotfiles/claude/.claude/rules/context-mode.md`
- Modify: `/Users/bharat/.dotfiles/claude/.claude/CLAUDE.md`
...
- [ ] **Step 1:** Create `/Users/bharat/.dotfiles/claude/.claude/rules/` dir: `mkdir -p /Users/bharat/.dotfiles/claude/.claude/rules`
...
- [ ] **Step 4:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/rules/context-mode.md claude/.claude/CLAUDE.md && git -C /Users/bharat/.dotfiles commit -m "refactor(rules): extract context-mode routing to separate file"`
...
- [ ] **Step 3:** Verify: `jq '.hooks.PreToolUse[] | select(.hooks[0].command | contains("superpowers") or contains("rtk")) | .hooks[0].command' /Users/bharat/.dotfiles/claude/.claude/settings.json`
- [ ] **Step 4:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/settings.json && git -C /Users/bharat/.dotfiles commit -m "fix(settings): reorder PreToolUse hooks for correct precedence"`
...
**Files:**
- Modify: `/Users/bharat/.dotfiles/claude/.claude/hooks/rtk-rewrite.sh`
...
- [ ] **Step 3:** Verify logging code present: `grep -q "LOGDIR\|LOGFILE" /Users/bharat/.dotfiles/claude/.claude/hooks/rtk-rewrite.sh && echo OK`
- [ ] **Step 4:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/hooks/rtk-rewrite.sh && git -C /Users/bharat/.dotfiles commit -m "observability(rtk-rewrite): log RTK failures to hooks.log"`
...
**Files:**
- Modify: `/Users/bharat/.dotfiles/claude/.claude/skills/pre-commit/SKILL.md`
...
- [ ] **Step 2:** Verify: `head -15 /Users/bharat/.dotfiles/claude/.claude/skills/pre-commit/SKILL.md | grep -i manual && echo OK`
- [ ] **Step 3:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/skills/pre-commit/SKILL.md && git -C /Users/bharat/.dotfiles commit -m "docs(pre-commit): mark as manual skill with invocation reminders"`
...
- [ ] **Step 1:** `sed -i '' 's/Janus/Neo/g' /Users/bharat/.claude/projects/-Users-bharat--dotfiles/memory/MEMORY.md`
- [ ] **Step 2:** Verify: `grep "Janus" /Users/bharat/.claude/projects/-Users-bharat--dotfiles/memory/MEMORY.md || echo "✓ All replaced"`
...
- [ ] **Step 5:** Verify all hooks: `for hook in /Users/bharat/.dotfiles/claude/.claude/hooks/*.sh; do grep -E ">> .*\.log" "$hook" | head -1 || echo "$(basename $hook): NO LOGGING"; done`
- [ ] **Step 6:** Commit: `git -C /Users/bharat/.dotfiles add claude/.claude/hooks/superpowers-redirect.sh && git -C /Users/bharat/.dotfiles commit -m "observability(hooks): standardize logging format across all hooks"`
...
for hook in /Users/bharat/.dotfiles/claude/.claude/hooks/*.sh; do
  bash -n "$hook" && echo "✓ $(basename $hook)" || echo "✗ $(basename $hook)"
done

# JSON valid
jq empty /Users/bharat/.dotfiles/claude/.claude/settings.json && echo "✓ settings.json" || echo "✗ settings.json"

# Files exist
[ -f /Users/bharat/.dotfiles/docs/claude-setup-hardening.md ] && echo "✓ Plan"
[ -f /Users/bharat/.dotfiles/claude/.claude/rules/context-mode.md ] && echo "✓ Rules"
```
...
- **Source editing:** All `claude/.claude/*` files edited in `/Users/bharat/.dotfiles/claude/.claude/`, NOT `~/.claude/` (those are stow symlinks)
- **Memory:** `/Users/bharat/.claude/projects/-Users-bharat--dotfiles/memory/MEMORY.md` is NOT stow-managed—edit directly, no git commit
